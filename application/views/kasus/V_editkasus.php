...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        ...
        <div class="collapse show" id="collapseCardExample">
            <div class="card-body">
                <h5 class="card-title text-center" style="font-weight:lighter"><strong><?= $status['nama_penyakit']; ?></strong></h5><br>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-primary"><?= $sub_judul . " " . $status['nama_penyakit']; ?></h6>
        </div>
        <div class="card-body">
            <h5 class="card-title text-center" style="font-weight:lighter"><strong>Silahkan Masukkan Gejala</strong></h5>
            <form class="form-group" method="post" action="">
                <input type="hidden" name="id_penyakit" id="id_penyakit" value="<?= $status['id_penyakit']; ?>">
