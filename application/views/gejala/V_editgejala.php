            ...
            <div class="col-md-12">
                <form class="form-group" method="post" action="">
                    ...
                    <div class="form-group">
                        <label for="formGroupExampleInput2">Kode Gejala</label><br>
                        <small class="text-danger">Masukkan Kode Gejala</small>
                        <input type="text" class="form-control col-md-4" name="kode" id="kode" placeholder="Kode Gejala" value="<?= $gejala['kode']; ?>">
                        <?= form_error('kode', '<small class="text-danger pl-3">', '</small>'); ?>
                    </div>
                    <div class="form-group">
                        <label for="formGroupExampleInput">Nama Gejala</label>
                        <input type="text" class="form-control" name="gejala" id="gejala" placeholder="Masukkan Nama Gejala" value="<?= $gejala['nama_ciri']; ?>">
