...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span style="font-size:14px; font-weight:300">Copyright &copy; PAKARRU 2022 | By : Septianda Reza Maulana</span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a class="btn btn-primary" href="<?= base_url('login/logout'); ?>">Yes</a>
            </div>
        </div>
    </div>
</div>
