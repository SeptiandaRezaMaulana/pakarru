                ...
                <div class="row">
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input readonly type="text" class="form-control col-md-lg" name="id_penyakit" id="id_penyakit" value="<?= $status['id_penyakit']; ?>">
                        </div>
                    </div>
                    ...
                    <div class="col-md-10">
                        <div class="form-group">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control col-md-lg" name="status" id="status" value="<?= $status['nama_penyakit']; ?>">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <textarea type="text" rows="4" class="form-control col-md-lg" name="solusi" id="solusi"><?= $status['solusi']; ?></textarea>
